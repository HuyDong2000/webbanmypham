        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="list_customer.php" class="active"><i class="fa fa-dashboard fa-fw"></i> Khách hàng </a>
                    </li>
                    <li>
                        <a href="list_oder.php" class="active"><i class="fa fa-dashboard fa-fw"></i> Đơn hàng </a>
                    </li>
