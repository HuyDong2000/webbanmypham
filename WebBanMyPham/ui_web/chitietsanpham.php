...
<body>
<form action="giohang.php?action=add" method="POST"><div id="menu">
    <div id="menu">
        <header>
        ...
        <article>
            <div class="main">
                ...
                $sql        =    "select * from tblproduct where MaLoai= " .$_GET['id'];
                ...
                ?>
                    <div class="box">
                        <div align="center">
                        <p class="tensach"><a href="Chitietsanpham.html"><?= $row["TenSP"] ?></a></p>
                        ...
                        <!-- <a href="#"><img class="nutchonmua" src="./image/nut_chonmua.gif"></a> -->
